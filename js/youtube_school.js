...
$(function() {
 ...
 if(isIE){
   ...
   document.getElementsByTagName("head")[0].appendChild(script);
	...
	$.getJSON(
		//学校のYoutubeユーザーを指定
		//"http://gdata.youtube.com/feeds/api/users/vista6364/uploads?max-results=6&v=2&alt=json", /* 日本 */
		"http://gdata.youtube.com/feeds/api/playlists/PLS5jn8RBBk45o3o77jaAL1v7WLhFLIIOa?alt=json",
		{
		   v:2,
		   alt:"json"
		},
